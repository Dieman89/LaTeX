...
\begin{document}
  ...
  % \chapter{Lab 2:}\label{c:Lab-2}
  % \input{text/lab2}

  % \chapter{Lab 3:}\label{c:Lab-3}
  % \input{text/lab3}

  % \chapter{Lab 4:}\label{c:Lab-4}
  % \input{text/lab4}

  % \chapter{Lab 5:}\label{c:Lab-5}
  % \input{text/lab5}

  % \chapter{Lab 6:}\label{c:Lab-6}
  % \input{text/lab6}

  % \chapter{Lab 7:}\label{c:Lab-7}
  % \input{text/lab7}

  % \chapter{Lab 8:}\label{c:Week-8}
  % \input{text/lab8}
